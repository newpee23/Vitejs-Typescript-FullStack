...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 21, 2023 at 06:13 AM
...
CREATE TABLE `custommer` (
  `id` int(11) NOT NULL,
  `lname` varchar(255) COLLATE utf8mb4_thai_520_w2 NOT NULL,
  `fname` varchar(255) COLLATE utf8mb4_thai_520_w2 NOT NULL,
  `gender` enum('Male','Female') COLLATE utf8mb4_thai_520_w2 NOT NULL,
  `phone` varchar(10) COLLATE utf8mb4_thai_520_w2 DEFAULT NULL,
  `email` varchar(255) COLLATE utf8mb4_thai_520_w2 DEFAULT NULL,
  `username` varchar(255) COLLATE utf8mb4_thai_520_w2 NOT NULL,
  `password` varchar(255) COLLATE utf8mb4_thai_520_w2 NOT NULL,
  `geographies_id` int(11) DEFAULT NULL,
  `provinces_id` int(11) DEFAULT NULL,
  `districts_id` int(11) DEFAULT NULL,
  `amphures_id` int(11) DEFAULT NULL,
  `status` enum('Active','InActive') COLLATE utf8mb4_thai_520_w2 NOT NULL,
